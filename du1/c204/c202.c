...
void Stack_Init( Stack *stack ) {
    ...
    if (stack == NULL){
        ...
        stack->topIndex = -1; //inicializace zasobnku na -1
    }
    return;
...
int Stack_IsFull( const Stack *stack ) {
    ...
    /* k promnenne musime pricitat jednicku protoze nam to slouzi jako ukazatel na posledni prvek, ktery u pole
     * o velikosti 20 je 19 a porovnavame to s konstantou MAX_STACK
    */
